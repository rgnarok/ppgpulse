...
- 2026-07-13 · T13.3 · GitHub Actions CI (verify + e2e with Postgres service), README (setup/env/scripts/RBAC/security), root Dockerfile (single-origin) + web nginx Dockerfile, docker-compose full stack (db + app) with boot migrate+seed.
